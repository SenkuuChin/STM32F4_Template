    ...
    #define SERIAL_COM1_DMA_TX_INSTANCE     DMA2_Stream7
    #define SERIAL_COM1_DMA_TX_CHANNEL      DMA_CHANNEL_4
    #define SERIAL_COM1_DMA_RX_INSTANCE     DMA2_Stream2
    #define SERIAL_COM1_DMA_RX_CHANNEL      DMA_CHANNEL_4
