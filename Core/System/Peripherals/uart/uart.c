...
__weak void USART2_Init(void)
{
    ...
    // 空闲中断，接收引脚需要配置为上拉
    // __HAL_UART_ENABLE_IT(&SerialNo2.handle, UART_IT_IDLE);
    // HAL_UART_Receive_DMA(&SerialNo2.handle, (uint8_t *)SerialNo2.data, SERIAL_DATA_LENGTH);
    // 最后的参数是一次性能接收的最大长度
...
__weak void USART3_Init(void)
{
    ...
    // 空闲中断，接收引脚需要配置为上拉
    // __HAL_UART_ENABLE_IT(&SerialNo3.handle, UART_IT_IDLE);
    // HAL_UART_Receive_DMA(&SerialNo3.handle, (uint8_t *)SerialNo3.data, SERIAL_DATA_LENGTH);
    // 最后的参数是一次性能接收的最大长度
...
__weak void UART4_Init(void)
{
    ...
    // 空闲中断，接收引脚需要配置为上拉
    // __HAL_UART_ENABLE_IT(&SerialNo4.handle, UART_IT_IDLE);
    // HAL_UART_Receive_DMA(&SerialNo4.handle, (uint8_t *)SerialNo4.data, SERIAL_DATA_LENGTH);
    // 最后的参数是一次性能接收的最大长度
...
__weak void USART5_Init(void)
{
    ...
    // 空闲中断，接收引脚需要配置为上拉
    // __HAL_UART_ENABLE_IT(&SerialNo5.handle, UART_IT_IDLE);
    // HAL_UART_Receive_DMA(&SerialNo5.handle, (uint8_t *)SerialNo1.data, SERIAL_DATA_LENGTH);
    // 最后的参数是一次性能接收的最大长度
...
__weak void USART6_Init(void)
{
    ...
    // 空闲中断，接收引脚需要配置为上拉
    // __HAL_UART_ENABLE_IT(&SerialNo6.handle, UART_IT_IDLE);
    // HAL_UART_Receive_DMA(&SerialNo6.handle, (uint8_t *)SerialNo6.data, SERIAL_DATA_LENGTH);
    // 最后的参数是一次性能接收的最大长度
